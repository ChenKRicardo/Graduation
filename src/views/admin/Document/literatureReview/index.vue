<template>
  <div class="literature">
    <div class="literature-text"><h3>文献综述信息统计</h3></div>
    <el-card>
      <!-- 头部 -->
...
export default {
  ...
  methods: {
    ...
    async getLiterature(pager = 1) {
      this.page = pager;
      const { page, limit } = this;
      try {
        let result = await this.$API.admin.reqStatisticsLiteratureInfo(
          page,
          limit
        );
        this.literatureInfo = result.data;
